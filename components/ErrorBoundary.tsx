...
class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-full bg-primary text-text-primary text-center p-8">
          ...
          <details className="mt-8 text-left bg-secondary p-4 rounded-lg max-w-xl w-full">
